(function (root, factory) {
    ...
    Backbone.ElementsView = Backbone.View.redefine(function (origin) {
        return /**@lends Backbone.View*/{
            ...
            /**
             * Собирает все кеши классов, селекторов, элементов
             * @private
             */
            _initElementCaches: function () {
                var name;
                for (name in this._classes()) this._elem(name);
                for (name in this._selectors()) this._elem(name);
            },
